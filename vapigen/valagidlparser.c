...
static void vala_gidl_parser_parse_object (ValaGIdlParser* self, GIdlNodeInterface* node, ValaSymbol* container, GIdlModule* module) {
	...
	ValaClass* _tmp10_;
	const gchar* _tmp136_;
	GIdlNodeInterface* _tmp159_;
	GList* _tmp160_;
	ValaClass* _tmp183_;
	ValaTypeSymbol* _tmp184_;
	GHashFunc _tmp185_;
	GEqualFunc _tmp186_;
	ValaHashSet* _tmp187_;
	GHashFunc _tmp188_;
	GEqualFunc _tmp189_;
	GEqualFunc _tmp190_;
	...
	GIdlNodeInterface* _tmp196_;
	GList* _tmp197_;
	GIdlNodeInterface* _tmp209_;
	GList* _tmp210_;
	GIdlNodeInterface* _tmp247_;
	GList* _tmp248_;
	ValaClass* _tmp318_;
	ValaClass* _tmp319_;
	ValaMethod* _tmp320_;
	...
	_tmp197_ = _tmp196_->members;
	{
		...
		for (member_it = member_collection; member_it != NULL; member_it = member_it->next) {
			...
			{
				GIdlNode* _tmp198_;
				GIdlNodeTypeId _tmp199_;
				GIdlNode* _tmp204_;
				GIdlNodeTypeId _tmp205_;
				_tmp198_ = member;
	...
	if (_tmp321_ == NULL) {
		...
		ValaCreationMethod* _tmp325_;
		ValaCreationMethod* cm;
		ValaCreationMethod* _tmp326_;
		ValaCreationMethod* _tmp327_;
		ValaClass* _tmp328_;
		ValaCreationMethod* _tmp329_;
		_tmp322_ = cl;
