...
"VABLE | G_TYPE_FLAG_DEEP_DERIVABLE) }");
	...
	if (_tmp185_) {
		...
		ValaCCodeAssignment* _tmp213_;
		ValaCCodeExpressionStatement* _tmp214_;
		ValaCCodeExpressionStatement* _tmp215_;
		_tmp186_ = plugin;
		if (_tmp186_) {
	...
	if (_tmp276_) {
		...
		ValaCCodeCastExpression* _tmp284_;
		ValaCCodeCastExpression* _tmp285_;
		...
		ValaCCodeCastExpression* _tmp293_;
		...
		if (_tmp296_) {
			...
			ValaCCodeInitializerList* _tmp332_;
			...
			ValaCCodeInitializerList* _tmp344_;
			...
			ValaCCodeDeclaration* _tmp353_;
			ValaCCodeBlock* _tmp354_;
			ValaCCodeDeclaration* _tmp355_;
	...
	if (_tmp401_) {
		...
		ValaCCodeBlock* _tmp418_;
		ValaCCodeFunctionCall* _tmp419_;
		ValaCCodeExpressionStatement* _tmp420_;
	...
	if (!_tmp425_) {
		...
		ValaCCodeIfStatement* _tmp477_;
		ValaCCodeIfStatement* cif;
		ValaCCodeBlock* _tmp478_;
		ValaCCodeIfStatement* _tmp479_;
	...
	if (_tmp482_) {
		...
		ValaCCodeReturnStatement* _tmp496_;
		_tmp491_ = type_block;
