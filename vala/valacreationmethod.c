...
static gboolean vala_creation_method_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	vala_semantic_analyzer_set_current_symbol (_tmp46_, (ValaSymbol*) self);
	{
		...
		gint _tmp50_ = 0;
		gint _param_index = 0;
		_tmp47_ = vala_method_get_parameters ((ValaMethod*) self);
		_param_list = _tmp47_;
		_tmp48_ = _param_list;
	...
	if (_tmp96_ != NULL) {
		...
		if (_tmp103_) {
			...
			ValaCreationMethod* _tmp114_ = NULL;
			ValaCreationMethod* _tmp115_ = NULL;
			_tmp111_ = cl;
			...
			if (_tmp115_ != NULL) {
				...
				ValaCreationMethod* _tmp119_ = NULL;
				ValaCreationMethod* _tmp120_ = NULL;
			...
			if (_tmp110_) {
				...
				ValaMemberAccess* _tmp142_ = NULL;
				...
				ValaMethodCall* _tmp149_ = NULL;
				ValaMethodCall* _tmp150_ = NULL;
				ValaSourceReference* _tmp151_ = NULL;
				ValaSourceReference* _tmp152_ = NULL;
				ValaExpressionStatement* _tmp153_ = NULL;
				ValaExpressionStatement* _tmp154_ = NULL;
				...
				ValaCreationMethod* _tmp173_ = NULL;
				_tmp169_ = cl;
				...
				if (_tmp173_ == NULL) {
					...
					ValaCreationMethod* _tmp178_ = NULL;
					ValaSymbolAccessibility _tmp179_ = 0;
				...
				if (_tmp168_) {
					...
					ValaCreationMethod* _tmp186_ = NULL;
					ValaCreationMethod* _tmp187_ = NULL;
					gint _tmp188_ = 0;
					_tmp183_ = cl;
					...
					if (_tmp188_ > 0) {
						...
						ValaSemanticAnalyzer* _tmp192_ = NULL;
						...
						ValaSemanticAnalyzer* _tmp229_ = NULL;
