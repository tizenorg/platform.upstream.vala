...
static gboolean vala_conditional_expression_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	ValaLocalVariable* _tmp159_ = NULL;
	ValaDataType* _tmp160_ = NULL;
	ValaDataType* _tmp161_ = NULL;
	ValaDeclarationStatement* _tmp162_ = NULL;
	...
	ValaMemberAccess* _tmp179_ = NULL;
	...
	ValaAssignment* _tmp187_ = NULL;
	ValaAssignment* _tmp188_ = NULL;
	...
	ValaExpressionStatement* _tmp194_ = NULL;
	ValaExpressionStatement* _tmp195_ = NULL;
	...
	ValaMemberAccess* _tmp205_ = NULL;
	...
	ValaAssignment* _tmp212_ = NULL;
	ValaAssignment* _tmp213_ = NULL;
	...
	ValaExpressionStatement* _tmp219_ = NULL;
	ValaExpressionStatement* _tmp220_ = NULL;
	ValaCodeContext* _tmp221_ = NULL;
	ValaBlock* _tmp222_ = NULL;
	ValaDeclarationStatement* _tmp223_ = NULL;
	ValaExpressionStatement* _tmp224_ = NULL;
	...
	ValaMemberAccess* _tmp233_ = NULL;
	...
	ValaCodeNode* _tmp242_ = NULL;
	ValaCodeNode* _tmp243_ = NULL;
	ValaMemberAccess* _tmp244_ = NULL;
	self = (ValaConditionalExpression*) base;
