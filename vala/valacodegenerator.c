...
static void vala_code_generator_real_store_parameter (ValaCodeGenerator* self, ValaParameter* param, ValaTargetValue* value, gboolean capturing_parameter);
...
void vala_code_generator_store_parameter (ValaCodeGenerator* self, ValaParameter* param, ValaTargetValue* value, gboolean capturing_parameter) {
	g_return_if_fail (self != NULL);
	VALA_CODE_GENERATOR_GET_CLASS (self)->store_parameter (self, param, value, capturing_parameter);
}
