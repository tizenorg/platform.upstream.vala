...
static gboolean vala_slice_expression_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp33_, VALA_TYPE_ARRAY_TYPE)) {
		...
		_tmp75_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp74_, VALA_TYPE_METHOD) ? ((ValaMethod*) _tmp74_) : NULL;
		if (_tmp75_ == NULL) {
			_vala_code_node_unref0 (_tmp74_);
		}
		slice_method = _tmp75_;
		_tmp76_ = slice_method;
		if (_tmp76_ != NULL) {
			...
			_tmp77_ = vala_slice_expression_get_container (self);
			_tmp78_ = _tmp77_;
			_tmp79_ = vala_member_access_new (_tmp78_, "slice", NULL);
			_tmp80_ = _tmp79_;
			_tmp81_ = vala_method_call_new ((ValaExpression*) _tmp80_, NULL);
			_tmp82_ = _tmp81_;
			_vala_code_node_unref0 (_tmp80_);
			slice_call = _tmp82_;
			_tmp83_ = slice_call;
			_tmp84_ = vala_slice_expression_get_start (self);
			_tmp85_ = _tmp84_;
			vala_method_call_add_argument (_tmp83_, _tmp85_);
			_tmp86_ = slice_call;
			_tmp87_ = vala_slice_expression_get_stop (self);
			_tmp88_ = _tmp87_;
			vala_method_call_add_argument (_tmp86_, _tmp88_);
			_tmp89_ = slice_call;
			_tmp90_ = vala_expression_get_target_type ((ValaExpression*) self);
			_tmp91_ = _tmp90_;
			vala_expression_set_target_type ((ValaExpression*) _tmp89_, _tmp91_);
			_tmp92_ = vala_code_node_get_parent_node ((ValaCodeNode*) self);
			_tmp93_ = _tmp92_;
			_tmp94_ = slice_call;
			vala_code_node_replace_expression (_tmp93_, (ValaExpression*) self, (ValaExpression*) _tmp94_);
			_tmp95_ = slice_call;
			_tmp96_ = context;
			_tmp97_ = vala_code_node_check ((ValaCodeNode*) _tmp95_, _tmp96_);
			result = _tmp97_;
		...
		_tmp99_ = _tmp98_;
		_tmp100_ = vala_slice_expression_get_container (self);
		_tmp101_ = _tmp100_;
		_tmp102_ = vala_expression_get_value_type (_tmp101_);
		_tmp103_ = _tmp102_;
		_tmp104_ = vala_code_node_to_string ((ValaCodeNode*) _tmp103_);
		_tmp105_ = _tmp104_;
		_tmp106_ = g_strdup_printf ("The expression `%s' does not denote an array", _tmp105_);
		_tmp107_ = _tmp106_;
		vala_report_error (_tmp99_, _tmp107_);
		_g_free0 (_tmp107_);
		_g_free0 (_tmp105_);
		_vala_code_node_unref0 (slice_method);
	}
	_tmp108_ = vala_code_node_get_error ((ValaCodeNode*) self);
	_tmp109_ = _tmp108_;
	result = !_tmp109_;
	return result;
}
