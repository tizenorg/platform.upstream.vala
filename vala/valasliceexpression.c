...
static gboolean vala_slice_expression_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp53_, VALA_TYPE_ARRAY_TYPE)) {
		...
		if (!_tmp62_) {
			...
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			_tmp71_ = vala_slice_expression_get_start (self);
			_tmp72_ = _tmp71_;
			_tmp73_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp72_);
			_tmp74_ = _tmp73_;
			vala_report_error (_tmp74_, "Expression of integer type expected");
		}
		_tmp76_ = vala_slice_expression_get_stop (self);
		_tmp77_ = _tmp76_;
		_tmp78_ = vala_expression_get_value_type (_tmp77_);
		_tmp79_ = _tmp78_;
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp79_, VALA_TYPE_INTEGER_TYPE)) {
			_tmp75_ = TRUE;
		} else {
			...
			_tmp80_ = vala_slice_expression_get_stop (self);
			_tmp81_ = _tmp80_;
			_tmp82_ = vala_expression_get_value_type (_tmp81_);
			_tmp83_ = _tmp82_;
			_tmp75_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp83_, VALA_TYPE_ENUM_VALUE_TYPE);
		}
		if (!_tmp75_) {
			...
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			_tmp84_ = vala_slice_expression_get_stop (self);
			_tmp85_ = _tmp84_;
			_tmp86_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp85_);
			_tmp87_ = _tmp86_;
			vala_report_error (_tmp87_, "Expression of integer type expected");
		}
	} else {
		...
		gchar* _tmp124_ = NULL;
		gchar* _tmp125_ = NULL;
		_tmp88_ = vala_slice_expression_get_container (self);
		_tmp89_ = _tmp88_;
		_tmp90_ = vala_expression_get_value_type (_tmp89_);
		_tmp91_ = _tmp90_;
		_tmp92_ = vala_data_type_get_member (_tmp91_, "slice");
		_tmp93_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp92_, VALA_TYPE_METHOD) ? ((ValaMethod*) _tmp92_) : NULL;
		if (_tmp93_ == NULL) {
			_vala_code_node_unref0 (_tmp92_);
		}
		slice_method = _tmp93_;
		_tmp94_ = slice_method;
		if (_tmp94_ != NULL) {
			...
			ValaMethodCall* _tmp99_ = NULL;
			ValaMethodCall* _tmp100_ = NULL;
			ValaMethodCall* _tmp101_ = NULL;
			...
			_tmp95_ = vala_slice_expression_get_container (self);
			_tmp96_ = _tmp95_;
			_tmp97_ = vala_member_access_new (_tmp96_, "slice", NULL);
			_tmp98_ = _tmp97_;
			_tmp99_ = vala_method_call_new ((ValaExpression*) _tmp98_, NULL);
			_tmp100_ = _tmp99_;
			_vala_code_node_unref0 (_tmp98_);
			slice_call = _tmp100_;
			_tmp101_ = slice_call;
			_tmp102_ = vala_slice_expression_get_start (self);
			_tmp103_ = _tmp102_;
			vala_method_call_add_argument (_tmp101_, _tmp103_);
			_tmp104_ = slice_call;
			_tmp105_ = vala_slice_expression_get_stop (self);
			_tmp106_ = _tmp105_;
			vala_method_call_add_argument (_tmp104_, _tmp106_);
			_tmp107_ = slice_call;
			_tmp108_ = vala_expression_get_target_type ((ValaExpression*) self);
			_tmp109_ = _tmp108_;
			vala_expression_set_target_type ((ValaExpression*) _tmp107_, _tmp109_);
			_tmp110_ = vala_code_node_get_parent_node ((ValaCodeNode*) self);
			_tmp111_ = _tmp110_;
			_tmp112_ = slice_call;
			vala_code_node_replace_expression (_tmp111_, (ValaExpression*) self, (ValaExpression*) _tmp112_);
			_tmp113_ = slice_call;
			_tmp114_ = context;
			_tmp115_ = vala_code_node_check ((ValaCodeNode*) _tmp113_, _tmp114_);
			result = _tmp115_;
		...
		_tmp117_ = _tmp116_;
		_tmp118_ = vala_slice_expression_get_container (self);
		_tmp119_ = _tmp118_;
		_tmp120_ = vala_expression_get_value_type (_tmp119_);
		_tmp121_ = _tmp120_;
		_tmp122_ = vala_code_node_to_string ((ValaCodeNode*) _tmp121_);
		_tmp123_ = _tmp122_;
		_tmp124_ = g_strdup_printf ("The expression `%s' does not denote an array", _tmp123_);
		_tmp125_ = _tmp124_;
		vala_report_error (_tmp117_, _tmp125_);
		_g_free0 (_tmp125_);
		_g_free0 (_tmp123_);
		_vala_code_node_unref0 (slice_method);
	}
...
static void vala_slice_expression_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	ValaCodeGenerator* _tmp9_ = NULL;
	ValaCodeGenerator* _tmp10_ = NULL;
	self = (ValaSliceExpression*) base;
